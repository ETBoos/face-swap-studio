...
private:
	bool Open(bool ForReceiving)
	{
		...
		char CS_NAME_MUTEX      [] = "FSSCapture_Mutx0"; CS_NAME_MUTEX      [sizeof(CS_NAME_MUTEX      ) - 2] = CSCapNumChar;
		char CS_NAME_EVENT_WANT [] = "FSSCapture_Want0"; CS_NAME_EVENT_WANT [sizeof(CS_NAME_EVENT_WANT ) - 2] = CSCapNumChar;
		char CS_NAME_EVENT_SENT [] = "FSSCapture_Sent0"; CS_NAME_EVENT_SENT [sizeof(CS_NAME_EVENT_SENT ) - 2] = CSCapNumChar;
		char CS_NAME_SHARED_DATA[] = "FSSCapture_Data0"; CS_NAME_SHARED_DATA[sizeof(CS_NAME_SHARED_DATA) - 2] = CSCapNumChar;
